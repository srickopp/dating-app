...
export class InitTable1706545584309 implements MigrationInterface {
    name = 'InitTable1706545584309';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "user_premiums" ("profile_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "package_id" character varying NOT NULL, "start_date" TIMESTAMP NOT NULL DEFAULT now(), "end_date" TIMESTAMP NOT NULL DEFAULT now(), "profileId" uuid, "packageId" uuid, CONSTRAINT "PK_f9564798dffc6f1ee63ba6e962a" PRIMARY KEY ("profile_id"))`,
        );
        await queryRunner.query(
            `CREATE TABLE "profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "name" character varying NOT NULL, "age" integer NOT NULL, "daily_swipe_count" integer NOT NULL DEFAULT '0', "likes_count" integer NOT NULL, "gender" character varying NOT NULL, "bio" character varying, "image_url" character varying, "is_verified" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_9e432b7df0d182f8d292902d1a" UNIQUE ("user_id"), CONSTRAINT "PK_8e520eb4da7dc01d0e190447c8e" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
